...
# ************************************************************
# **IMPORTANT BEFORE RUNNING THE NOTEBOOK:** You are about to run a heavy notebook which, which will imply costs on your environment. Consider studying from the pre-run results and copy only the parts you need for your environment.
# **********************************************************
